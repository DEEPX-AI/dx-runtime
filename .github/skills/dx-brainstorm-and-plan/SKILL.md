...
> - `dx_app/.github/skills/dx-brainstorm-and-plan.md` (standalone inference)
> - `dx_stream/.github/skills/dx-brainstorm-and-plan.md` (GStreamer pipelines)
...
- For dx_app tasks → delegate to `dx_app/.github/skills/dx-brainstorm-and-plan.md`
- For dx_stream tasks → delegate to `dx_stream/.github/skills/dx-brainstorm-and-plan.md`
