...
<!-- Source: .deepx/skills/dx-validate-and-fix/SKILL.md -->
...
| `dx-validate-and-fix.md` | Unified (dx-runtime) | Full loop — validate, collect, approve, apply, verify |
...
```json
{
  ...
  "preview": "- `skills/dx-validate.md` → `skills/dx-validate-and-fix.md`"
}
```
