...
├── skills/
│   ├── dx-agent-runtime-validate.md         # Full validate → collect → approve → apply → verify loop
...
|---|---|---|
| **Python app, detection, factory** | dx_app | `dx_app/.deepx/skills/dx-agent-app-build-python.md`, `dx_app/.deepx/toolsets/common-framework-api.md` |
| **C++ app, native engine** | dx_app | `dx_app/.deepx/skills/dx-agent-app-build-cpp.md`, `dx_app/.deepx/toolsets/dx-engine-api.md` |
