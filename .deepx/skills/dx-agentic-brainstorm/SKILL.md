...
> - `dx_app/.deepx/skills/dx-agentic-brainstorm.md` (standalone inference)
> - `dx_stream/.deepx/skills/dx-agentic-brainstorm.md` (GStreamer pipelines)
...
- For dx_app tasks → delegate to `dx_app/.deepx/skills/dx-agentic-brainstorm.md`
- For dx_stream tasks → delegate to `dx_stream/.deepx/skills/dx-agentic-brainstorm.md`
